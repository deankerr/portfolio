...
stack:
  - name: 'ts-morph'
    note: 'the TypeScript compiler API, doing the extraction from type-checked source rather than regex or import-parsing heuristics'
  - name: 'Cytoscape.js + dagre'
    note: 'the interactive dependency graph and its layout, embedded in one HTML file (the libraries load from a CDN)'
  - name: 'commander'
    note: 'the CLI surface'
  - name: 'Bun'
    note: 'runtime and tooling; two runtime dependencies total'
---
