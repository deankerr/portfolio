...
stack:
  - name: 'POSIX shell'
    note: 'two scripts, ~225 lines, no application code or dependencies'
  - name: 'OrbStack'
    note: 'driven entirely through the orb CLI'
  - name: 'Linux primitives'
    note: 'unshare mount namespaces, tmpfs overlays, setpriv privilege dropping, POSIX ACLs'
---
